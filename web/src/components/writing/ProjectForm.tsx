 ...
 */
export default function ProjectForm({ form, open, submitting, onOk, onCancel }: ProjectFormProps) {
  ...
  const allTemplates: Template[] = [...templates, ...userTemplates.map(userTemplateToTemplate)];
      ...
      <Form form={form} layout="vertical" style={{ marginTop: 16 }}>
        ...
        {selectedTemplate && (
          ...
          >
            <Typography.Text
              className="pf-serif"
              style={{ fontSize: 13, fontWeight: 600, color: "var(--pf-primary)" }}
            >
              {selectedTemplate.name}
            </Typography.Text>
            <Typography.Text style={{ fontSize: 12, color: "var(--pf-text-muted)", marginLeft: 8 }}>
