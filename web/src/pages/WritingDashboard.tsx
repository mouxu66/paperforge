    ...
    <svg width={width} height={height} style={{ display: 'block' }}>
      ...
      {points.map((p) => (
        <g key={p.date}>
          ...
          <text x={p.x} y={height - padding + 14} textAnchor="middle" fontSize={10} fill="#94a3b8">
            {p.date.slice(5)}
          </text>
        </g>
      ))}
    ...
    <div style={{ maxWidth: 1000, margin: '0 auto' }}>
      ...
      {stats && (
        <div style={{ display: 'flex', gap: 12, marginBottom: 20, flexWrap: 'wrap' }}>
          <Card className="pf-glass-card" variant="borderless" style={{ flex: '1 1 140px', minWidth: 140 }}>
            <Statistic
              title={t('write.statTotalProjects')}
              value={stats.totalProjects}
              prefix={<ProjectOutlined style={{ color: '#1e40af' }} />}
            />
          </Card>
          <Card className="pf-glass-card" variant="borderless" style={{ flex: '1 1 140px', minWidth: 140 }}>
            <Statistic
              ...
              prefix={<FileWordOutlined style={{ color: '#16a34a' }} />}
          ...
          <Card className="pf-glass-card" variant="borderless" style={{ flex: '1 1 140px', minWidth: 140 }}>
            <Statistic
              ...
              valueStyle={{ color: stats.todayWords > 0 ? '#16a34a' : '#94a3b8' }}
            />
          </Card>
          <Card
      ...
      {loading ? (
        ...
        <Card className="pf-glass-card" variant="borderless" style={{ textAlign: 'center', padding: 48 }}>
          <FileTextOutlined style={{ fontSize: 40, color: '#cbd5e1', marginBottom: 16 }} />
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          {projects.map((p) => (
            <Card
              key={p.id}
              className="pf-glass-card pf-card-hover"
              variant="borderless"
              ...
              >
                <div style={{ flex: 1, minWidth: 0 }}>
                  <Space size={8} align="center">
                    ...
                    <span
                      className="pf-serif"
                      style={{ fontSize: 17, fontWeight: 600, color: '#1a1a2e' }}
                    >
                      {p.title}
                    </span>
                  ...
                  <div style={{ marginTop: 8, display: 'flex', gap: 6, flexWrap: 'wrap' }}>
                    {p.keywords.length > 0 ? (
                      ...
                      <span style={{ fontSize: 12, color: '#94a3b8' }}>{t('write.noKeywords')}</span>
                    )}
                  </div>
                  <div style={{ marginTop: 8, fontSize: 12, color: '#94a3b8' }}>
                    {p.targetJournal && <span>{t('write.targetJournal')}：{p.targetJournal} · </span>}
                  ...
                  <div key={p.id}>
                    ...
                    >
                      ...
                      <Tag color="blue" style={{ margin: 0 }}>
                        {t('write.wordCountTotal', { total: wc.total, chapters: wc.chapters.length })}
                      </Tag>
                    </div>
      ...
      <Modal
        title={
          <Space>
            <ExperimentOutlined style={{ color: '#1e40af' }} />
        ...
        {outlineStage === 'error' && (
          <div style={{ padding: '16px 0' }}>
            <Typography.Text type="danger" style={{ fontSize: 14 }}>
              {t('write.outlineGenerateFailed', { error: outlineError || t('common.unknownError') })}
            </Typography.Text>
            <div style={{ marginTop: 8, fontSize: 12, color: '#94a3b8' }}>
